...
class TestRequiresOptionalImportCallables:
    def test_function_attributes(self):
        ...
        with pytest.raises(
            ImportError,
            match=r"Module 'some_optional_module' needed for some_random_module.dummy_stuff.dummy_function is missing, please install it using 'pip install os1\[optional_dep\]'",
        ):
            actual()
    ...
    def test_function_call(self):
        ...
        with pytest.raises(
            ImportError,
            match=r"Module 'some_optional_module' needed for test.test_import_utils.dummy_function is missing, please install it using 'pip install os1\[optional_dep\]'",
        ):
            dummy_function()
    ...
    def test_method_attributes(self):
        ...
        with pytest.raises(
            ImportError,
            match=r"Module 'some_optional_module' needed for some_random_module.dummy_stuff.dummy_method is missing, please install it using 'pip install os1\[optional_dep\]",
        ):
            dummy.dummy_method()
    ...
    def test_method_call(self):
        ...
        with pytest.raises(
            ImportError,
            match=r"Module 'some_optional_module' needed for test.test_import_utils.dummy_method is missing, please install it using 'pip install os1\[optional_dep\]'",
        ):
            dummy.dummy_method()
    ...
    def test_static_call(self):
        ...
        with pytest.raises(
            ImportError,
            match=r"Module 'some_optional_module' needed for test.test_import_utils.dummy_static_function is missing, please install it using 'pip install os1\[optional_dep\]'",
        ):
    ...
    def test_property_call(self):
        ...
        with pytest.raises(
            ImportError,
            match=r"Module 'some_optional_module' needed for test.test_import_utils.dummy_property is missing, please install it using 'pip install os1\[optional_dep\]'",
        ):
...
class TestRequiresOptionalImportClasses:
    ...
    def test_class_init_call(self, dummy_cls: Type[Any]):
        with pytest.raises(
            ImportError,
            match=r"Module 'some_optional_module' needed for __init__ is missing, please install it using 'pip install os1\[optional_dep\]'",
        ):
            dummy_cls()
