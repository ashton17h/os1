...
class TestUpdateNavigation:
    def setup(self, temp_dir: Path) -> None:
        ...
        mint_json_content = {
            "name": "os1",
            "logo": {"dark": "/logo/os1-white.svg", "light": "/logo/os1.svg"},
            "navigation": [
    ...
    def test_dir(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            post2_content = textwrap.dedent("""
                ---
                title: Introducing RealtimeAgent Capabilities in os1
                authors:
                    - marklysze
                    - sternakt
                    - davorrunje
