...
from autogen.tools.dependency_injection import Field as os1Field
...
def g(  # type: ignore[empty-body]
    a: Annotated[str, os1Field(description="Parameter a")],
    b: int = 2,
    c: Annotated[float, os1Field(description="Parameter c")] = 0.1,
    *,
...
def test_get_parameter_json_schema() -> None:
    ...
    assert get_parameter_json_schema("a", Annotated[str, os1Field(description="parameter a")], {}) == {
        "type": "string",
        "description": "parameter a",
    }
    assert get_parameter_json_schema("a", Annotated[str, os1Field(description="parameter a")], {"a": "3.14"}) == {
        "type": "string",
        "description": "parameter a",
        "default": "3.14",
    }
    assert get_parameter_json_schema(
        "d", Annotated[Optional[str], os1Field(description="parameter d")], {"d": None}
    ) == {
...
def test_get_parameters() -> None:
    def f(  # type: ignore[no-untyped-def]
        ...
        c: Annotated[float, os1Field(description="Parameter c")] = 1.0,
    ):
        pass
...
def test_get_function_schema_no_return_type() -> None:
    def f(a: Annotated[str, os1Field(description="Parameter a")], b: int, c: float = 0.1):  # type: ignore[no-untyped-def]
        pass
