...
from .pydantic_ai_tool import PydanticAITool as os1PydanticAITool
...
class PydanticAIInteroperability:
    ...
    @classmethod
    def convert_tool(cls, tool: Any, deps: Any = None, **kwargs: Any) -> os1PydanticAITool:
        ...
        Returns:
            os1PydanticAITool: A standardized `Tool` object converted from the Pydantic AI tool.
