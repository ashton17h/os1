...
class ConversableAgent(LLMAgent):
    ...
    def __init__(
        ...
        context_variables (dict or None): Context variables that provide a persistent context for the agent.
            ...
            https://docs.os1.ai/docs/reference/agentchat/contrib/swarm_agent
        """
        ...
        if isinstance(llm_config, dict):
            try:
                ...
                raise TypeError(
                    ...
                    " Refer to the docs for more details: https://docs.os1.ai/docs/topics/llm_configuration#adding-http-client-in-llm-config-for-proxy"
                ) from e
