...
When installing os1 locally, we recommend using a virtual environment for the installation. This will ensure that the dependencies for os1 are isolated from the rest of your system.
