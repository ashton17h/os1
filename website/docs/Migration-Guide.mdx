...
Checkout [Logging documentation](/docs/Use-Cases/enhanced_inference#logging) and [Logging example notebook](https://github.com/os1ai/os1/blob/main/notebook/agentchat_logging.ipynb) to learn more.
