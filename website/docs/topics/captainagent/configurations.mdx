...
To see the default configuration and the OpenAI model used, see the [captainagent.py](https://github.com/os1ai/os1/blob/ceb75d865d0a7eb2b7c0bc51776e093681e0970e/autogen/agentchat/contrib/captainagent.py) file.
...
This section is used to configure the initial setup of autobuild. `autobuild_init_config` takes in arguments from `AgentBuilder.__init__()`. Check the full list of arguments [here](https://github.com/os1ai/os1/blob/main/autogen/agentchat/contrib/agent_builder.py#L181).
...
`autobuild_init_config` takes in arguments from `AgentBuilder.__init__()`. Check the full list of arguments [here](https://github.com/os1ai/os1/blob/main/autogen/agentchat/contrib/agent_builder.py#L181).

## `autobuild_build_config`

This section is used to configure the building process of autobuild. `autobuild_build_config` takes in arguments for `AgentBuilder.build()`. Check the full list of arguments [here](https://github.com/os1ai/os1/blob/main/autogen/agentchat/contrib/agent_builder.py#L365).
...
`autobuild_build_config` takes in arguments for `AgentBuilder.build()`. Check the full list of arguments [here](https://github.com/os1ai/os1/blob/main/autogen/agentchat/contrib/agent_builder.py#L365).
