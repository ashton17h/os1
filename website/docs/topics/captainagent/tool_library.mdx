...
We provide a list of tools that comes with the release of CaptainAgent. Its full content can be found [here](https://github.com/os1ai/os1/tree/main/autogen/agentchat/contrib/captainagent/tools/README.md)
...
```
pip install -r https://raw.githubusercontent.com/os1ai/os1/refs/heads/main/autogen/agentchat/contrib/captainagent/tools/requirements.txt
```
