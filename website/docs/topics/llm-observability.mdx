...
AutoGen's SQLite and File Logger - [Tutorial Notebook](/notebooks/agentchat_logging)

### Full-Service Partner Integrations

- AutoGen partners with [AgentOps](https://agentops.ai) to provide multi-agent tracking, metrics, and monitoring - [Tutorial Notebook](/notebooks/agentchat_agentops)
- AutoGen partners with [OpenLIT](https://github.com/openlit/openlit) to provide OpenTelemetry-native agent observability, which includes full execution traces and metrics - [Tutorial Notebook](https://github.com/ashton17h/os1/blob/main/notebook/agentchat_openlit.ipynb)
