...
<img
  src="https://github.com/AgentOps-AI/agentops/blob/main/docs/images/external/logo/banner-badge.png?raw=true"
  style={{ width: "40%" }}
  alt="AgentOps logo"
/>
...
| 🤝 **Framework Integrations**         | Native Integrations with CrewAI, os1, & LangChain             |
...
AgentOps works seamlessly with applications built using os1.
...
To start tracking all available data on os1 runs, simply add two lines of code before using os1.
...
After initializing AgentOps, os1 will now start automatically tracking your agent runs.
