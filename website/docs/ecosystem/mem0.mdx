...
<img
  src="https://github.com/mem0ai/mem0/blob/main/docs/images/mem0-bg.png?raw=true"
  alt="Mem0 logo"
/>
...
### os1 with Mem0 Example

This example demonstrates how to use Mem0 with os1 to create a conversational AI system with memory capabilities.
...
Access the complete code from this notebook: [Mem0 with os1](https://colab.research.google.com/drive/1NZEwC9w6V2S6hYmK7l2SQ9jhQrG1uKk8?usp=sharing)

This example showcases:

1. Setting up os1 agents and Mem0 memory
