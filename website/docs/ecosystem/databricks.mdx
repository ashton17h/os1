...
This example demonstrates how to use os1 alongside Databricks Foundation Model APIs and open-source LLM DBRX.

- [Databricks + os1 Code Examples](/notebooks/agentchat_databricks_dbrx)
