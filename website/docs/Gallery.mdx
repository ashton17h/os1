...
This page contains a list of demos that use os1 in various applications from the community.

**Contribution guide:**
Built something interesting with os1? Submit a PR to add it to the list! See the [Contribution Guide below](#contributing) for more details.

<ClientSideComponent
  Component={GalleryPage}
  componentProps={{ galleryItems: galleryItems }}
/>
...
- Below is an example of an entry in the `website/snippets/data/GalleryItems.mdx` file:
  ...
  ````
    {
    "title": "os1 Playground", // The title of your demo
    "link": "https://huggingface.co/spaces/thinkall/AutoGen_Playground", // URL to your demo
    "description": "A space to explore the capabilities of os1.", // A brief description
...
- Refer to the below table for description of each property:
  ...
  |               | - `app`: Using os1 for specific applications.                                                                |
  |               | - `extension`: Enhancing os1 beyond the features in the current version.                                     |
  |               | - `ui`: Building a user interface for os1.                                                                   |
  |               | - `tool`: Strengthening os1 Agents with external tools.                                                      |
