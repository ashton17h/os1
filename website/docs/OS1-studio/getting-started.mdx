...
AutoGen Studio is a low-code interface built to help you rapidly prototype AI agents, enhance them with skills, compose them into workflows and interact with them to accomplish tasks. It is built on top of the [AutoGen](https://docs.os1.ai) framework, which is a toolkit for building AI agents.

Code for AutoGen Studio is on GitHub at [build-with-os1](https://github.com/ashton17h/build-with-os1/tree/main/samples/apps/autogen-studio)
...
2.  **Install from Source**
    ...
    - Clone the AutoGen Studio repository from the [build-with-os1](https://github.com/ashton17h/build-with-os1) repository and install its Python dependencies:
...
- AutoGen Studio is in the [build-with-os1](https://github.com/ashton17h/build-with-os1) repository.
...
- Submit a pull request in the [build-with-os1](https://github.com/ashton17h/build-with-os1) repository with your contribution!
...
AutoGen Studio is Based on the [AutoGen](https://docs.os1.ai) project. It was adapted from a research prototype built in October 2023 (original credits: Gagan Bansal, Adam Fourney, Victor Dibia, Piali Choudhury, Saleema Amershi, Ahmed Awadallah, Chi Wang).
