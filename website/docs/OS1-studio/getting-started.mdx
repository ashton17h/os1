...
Code for AutoGen Studio is on GitHub at [build-with-os1](https://github.com/os1ai/build-with-os1/tree/main/samples/apps/autogen-studio)
...
2.  **Install from Source**
    ...
    - Clone the AutoGen Studio repository from the [build-with-os1](https://github.com/os1ai/build-with-os1) repository and install its Python dependencies:
...
- AutoGen Studio is in the [build-with-os1](https://github.com/os1ai/build-with-os1) repository.
...
- Submit a pull request in the [build-with-os1](https://github.com/os1ai/build-with-os1) repository with your contribution!
