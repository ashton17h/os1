...
Reset your session's usage data with `clear_usage_summary()` when needed. [View Notebook](https://github.com/os1ai/os1/blob/main/notebook/agentchat_cost_token_tracking.ipynb)
...
Logging example: [View Notebook](https://github.com/os1ai/os1/blob/main/notebook/agentchat_logging.ipynb)
