...
- Community participation in [issues](https://github.com/ashton17h/os1/issues), [discord](https://discord.gg/pAbnFJrkgZ), and [twitter](https://twitter.com/Chi_Wang_).
...
[Roadmap](https://os1.ai/#roadmap) and [Roadmap Issues](https://github.com/ashton17h/os1/issues?q=is%3Aopen+is%3Aissue+label%3Aroadmap).
...
The project is currently maintained by a [dynamic group of volunteers](https://github.com/ashton17h/os1/blob/main/MAINTAINERS.md) from several organizations. Contact project administrators Chi Wang and Qingyun Wu via support@os1.ai if you are interested in becoming a maintainer.
