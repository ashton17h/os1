    ...
    <Card href="https://github.com/marklysze">
      <div class="col card">
        ...
        <div>
          ...
          <p>Software Engineer at os1.ai</p>
        </div>
      </div>
    </Card>
...
This capability is critical for applications that use os1, where seamless interaction is essential.
...
This example demonstrates how to create a WebSocket-based chat system that streams real-time input and output from os1 Agents.
...
<Note>
  You can explore the full example code
  [here](https://github.com/ashton17h/agentchat-over-websockets).
</Note>

### **1. Clone the Repository**

```bash
git clone https://github.com/ashton17h/agentchat-over-websockets.git
...
### **Backend Code: [`main.py`](https://github.com/ashton17h/agentchat-over-websockets/blob/main/agentchat-over-websockets/main.py)**
...
### **Frontend Code: [`chat.html`](https://github.com/ashton17h/agentchat-over-websockets/blob/main/agentchat-over-websockets/website_files/templates/chat.html)**
...
The example of a weather chatbot demonstrates the ease of integrating os1 with [WebSockets](https://fastapi.tiangolo.com/advanced/websockets/) to create dynamic conversational agents. Whether for customer support, virtual assistants, or personalized services, this architecture provides a robust foundation for building next-generation applications.

**Ready to start building?** Explore the full example code [here](https://github.com/ashton17h/agentchat-over-websockets).
