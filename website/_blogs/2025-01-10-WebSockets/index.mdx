...
<Note>
  ...
  [here](https://github.com/os1ai/agentchat-over-websockets).
</Note>

### **1. Clone the Repository**

```bash
git clone https://github.com/os1ai/agentchat-over-websockets.git
...
### **Backend Code: [`main.py`](https://github.com/os1ai/agentchat-over-websockets/blob/main/agentchat-over-websockets/main.py)**
...
### **Frontend Code: [`chat.html`](https://github.com/os1ai/agentchat-over-websockets/blob/main/agentchat-over-websockets/website_files/templates/chat.html)**
...
**Ready to start building?** Explore the full example code [here](https://github.com/os1ai/agentchat-over-websockets).
