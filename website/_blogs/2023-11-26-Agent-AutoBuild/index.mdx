...
- [AutoBuild Examples](https://github.com/ashton17h/os1/blob/main/notebook/autobuild_basic.ipynb)
- [AgentBuilder](https://github.com/ashton17h/os1/blob/main/autogen/agentchat/contrib/agent_builder.py)
