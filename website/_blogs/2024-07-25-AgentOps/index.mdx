...
<img
  src="https://github.com/AgentOps-AI/agentops/blob/main/docs/images/external/autogen/autogen-integration.png?raw=true"
  alt="AgentOps and AutoGen"
  style={{ maxWidth: "50%" }}
/>
...
<img
  src="https://github.com/AgentOps-AI/agentops/blob/main/docs/images/external/autogen/dashboard.png?raw=true"
  alt="AgentOps overview dashboard"
  style={{ maxWidth: "100%" }}
/>
