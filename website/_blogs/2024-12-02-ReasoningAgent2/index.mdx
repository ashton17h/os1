---
title: ReasoningAgent - Tree of Thoughts with Beam Search in os1
authors:
  - Hk669
  - BabyCNM
  - skzhang1
...
<iframe
  width="560"
  height="315"
  src="https://www.youtube.com/embed/sS8Q5yMuEhs?si=MfWmzflK94S94FEx"
...
- We introduce **ReasoningAgent**, an os1 agent that implements tree-of-thought reasoning with beam search to solve complex problems.
...
Large language models (LLMs) have shown impressive capabilities in various tasks, but they can still struggle with complex reasoning problems that require exploring multiple solution paths. To address this limitation, we introduce ReasoningAgent, an os1 agent that implements tree-of-thought reasoning with beam search.
...
- [Example notebook](https://docs.os1.ai/notebooks/agentchat_reasoning_agent)
...
_Do you have interesting use cases for ReasoningAgent? Would you like to see more features or improvements? Please join our [Discord](https://discord.com/invite/pAbnFJrkgZ) server for discussion._
