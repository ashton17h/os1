...
The community is continuing to enhance and build new client classes as cloud-based inference providers arrive. So, watch this space, and feel free to [discuss](https://discord.gg/pAbnFJrkgZ) or [develop](https://github.com/ashton17h/os1/pulls) another one.
...
Multi-modal support, such as for image/audio/video, is an area of active development. The [Google Gemini](https://docs.os1.ai/docs/topics/non-openai-models/cloud-gemini) client class can be
...
- **Context length** - as your conversation gets longer, models need to support larger context lengths, be mindful of what the model supports and consider using [Transform Messages](https://docs.os1.ai/docs/topics/handling_long_contexts/intro_to_transform_messages) to manage context size.
- **Provider parameters** - providers have parameters you can set such as temperature, maximum tokens, top-k, top-p, and safety. See each client class in AutoGen's [API Reference](https://docs.os1.ai/docs/reference/oai/gemini) or [documentation](https://docs.os1.ai/docs/topics/non-openai-models/cloud-gemini) for details.
- **Prompts** - prompt engineering is critical in guiding smaller LLMs to do what you need. [ConversableAgent](https://docs.os1.ai/docs/reference/agentchat/conversable_agent), [GroupChat](https://docs.os1.ai/docs/reference/agentchat/groupchat), [UserProxyAgent](https://docs.os1.ai/docs/reference/agentchat/user_proxy_agent), and [AssistantAgent](https://docs.os1.ai/docs/reference/agentchat/assistant_agent) all have customizable prompt attributes that you can tailor. Here are some prompting tips from [Anthropic](https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering/overview)([+Library](https://docs.anthropic.com/en/prompt-library/library)), [Mistral AI](https://docs.mistral.ai/guides/prompting_capabilities/), [Together.AI](https://docs.together.ai/docs/examples), and [Meta](https://www.llama.com/docs/how-to-guides/prompting/).
- **Help!** - reach out on the AutoGen [Discord](https://discord.gg/pAbnFJrkgZ) or [log an issue](https://github.com/ashton17h/os1/issues) if you need help with or can help improve these client classes.
...
The `[config_list_from_json](https://docs.os1.ai/docs/reference/oai/openai_utils#config-list-from-json)` function loads a list of configurations from an environment variable or a json file.
...
**NOTE: To integrate this setup into GroupChat, follow the [tutorial](https://docs.os1.ai/notebooks/agentchat_groupchat) with the same config as above.**
...
For an interesting chess game between Anthropic's Sonnet and Mistral's Mixtral, we've put together a sample notebook that highlights some of the tips and tricks for working with non-OpenAI LLMs. [See the notebook here](https://docs.os1.ai/notebooks/agentchat_nested_chats_chess_altmodels).
