...
OpenAI assistants are now integrated into AutoGen via [`GPTAssistantAgent`](https://github.com/os1ai/os1/blob/main/autogen/agentchat/contrib/gpt_assistant_agent.py).
...
- [Basic example](https://github.com/os1ai/os1/blob/main/notebook/agentchat_oai_assistant_twoagents_basic.ipynb)
- [Code interpreter](https://github.com/os1ai/os1/blob/main/notebook/agentchat_oai_code_interpreter.ipynb)
- [Function calls](https://github.com/os1ai/os1/blob/main/notebook/agentchat_oai_assistant_function_call.ipynb)
...
Checkout more examples [here](https://github.com/os1ai/os1/tree/main/notebook).
