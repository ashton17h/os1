...
An interactive and easy way to get started is by following the notebook [here](https://github.com/ashton17h/os1/blob/main/notebook/agentchat_custom_model.ipynb) which loads a local model from HuggingFace into AutoGen and uses it for inference, and making changes to the class provided.
