...
You can find the full example [here](https://github.com/os1ai/realtime-agent-over-websockets/tree/main).
...
```bash
git clone https://github.com/os1ai/realtime-agent-over-websockets.git
