...
ragproxyagent = RetrieveUserProxyAgent(
    ...
    retrieve_config={
        "task": "qa",
        "docs_path": "https://raw.githubusercontent.com/os1ai/os1/main/README.md",
    },
)
```
...
check out the code [here](https://github.com/os1ai/os1/blob/main/autogen/agentchat/contrib/vectordb/base.py).
...
- [Using RetrieveChat with Qdrant for Retrieve Augmented Code Generation and Question Answering](https://github.com/os1ai/os1/blob/main/notebook/agentchat_RetrieveChat_qdrant.ipynb)
- [Using RetrieveChat Powered by PGVector for Retrieve Augmented Code Generation and Question Answering](https://github.com/os1ai/os1/blob/main/notebook/agentchat_RetrieveChat_pgvector.ipynb)
- [Using RetrieveChat Powered by MongoDB Atlas for Retrieve Augmented Code Generation and Question Answering](https://github.com/os1ai/os1/blob/main/notebook/agentchat_RetrieveChat_mongodb.ipynb)
