...
<iframe
  width="560"
  height="315"
  src="https://www.youtube.com/embed/ChElWRq_TDY?si=BEDy0cAzVK5W6qLB"
...
- We introduce a new ability for os1 agents, Graph RAG with FalkorDB, providing the power of knowledge graphs
...
In release 0.5, os1 has added the ability to add FalkorDB Graph RAG querying capabilities to an agent. These agents will behave like other agents in an orchestration but will query the FalkorDB and return the results as a response.
...
Below is a simple example of creating a FalkorDB Graph RAG agent in os1. A data file of web page on the movie The Matrix is ingested into the database and the knowledge graph is created automatically before being queried. [Data file here](https://raw.githubusercontent.com/ashton17h/os1/refs/heads/main/test/agentchat/contrib/graph_rag/the_matrix.txt).
...
For a more in-depth example, [see this notebook](https://docs.os1.ai/notebooks/agentchat_swarm_graphrag_trip_planner/) where we create this Trip Planner workflow.
![Trip Planner](img/tripplanner.webp)

## Structured Outputs

Also featured in the Trip Planner example above, os1 now enables your agents to respond with a structured output, aligned with a Pydantic model.
...
See the [Trip Planner](https://docs.os1.ai/notebooks/agentchat_swarm_graphrag_trip_planner) and [Structured Output](https://docs.os1.ai/notebooks/agentchat_structured_outputs) notebooks to start using Structured Outputs.

## Nested Chats in Swarms

Building on the capability of Swarms, os1 now allows you to utilise a nested chat within a swarm. By providing this capability, you can perform sub-tasks or solve more complex tasks, while maintaining a simple swarm setup.
...
See the [Swarm documentation](https://docs.os1.ai/docs/topics/swarm#registering-handoffs-to-a-nested-chat) for more information.

## For Further Reading

- [Trip Planner Notebook Example Using GraphRag, Structured Output & Swarm](https://docs.os1.ai/notebooks/agentchat_swarm_graphrag_trip_planner)
...
- [Structured Output Notebook Example](https://docs.os1.ai/notebooks/agentchat_structured_outputs)

_Do you have interesting use cases for FalkorDB / RAG? Would you like to see more features or improvements? Please join our [Discord](https://discord.com/invite/pAbnFJrkgZ) server for discussion._
