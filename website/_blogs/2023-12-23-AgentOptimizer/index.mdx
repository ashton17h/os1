...
**Notebook**: https://github.com/ashton17h/os1/blob/main/notebook/agentchat_agentoptimizer.ipynb.
...
conversation_history is a list of dictionaries which could be got from chat_messages_for_summary in the [AgentChat](https://docs.os1.ai/docs/reference/agentchat/chat) class.
