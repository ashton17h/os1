...
- 22K+ stars on [GitHub](https://github.com/os1ai/os1), 3K+ forks
...
- [AutoBuild](/blog/2023-11-26-Agent-AutoBuild/index). AutoBuild is an ongoing area of research to automatically create or select a group of agents for a given task and objective. If successful, it will greatly reduce the effort from users or developers when using the multi-agent technology. It also paves the way for agentic decomposition to handle complex tasks. It is available as an experimental feature and demonstrated in two modes: free-form [creation](https://github.com/os1ai/os1/blob/main/notebook/autobuild_basic.ipynb) and [selection](https://github.com/os1ai/os1/blob/main/notebook/autobuild_agent_library.ipynb) from a library.
...
- new features like [stateful code execution](/docs/tutorial/code-executors), [tool decorators](/docs/tutorial/tool-use), [long context handling](/notebooks/agentchat_transform_messages), [web agents](https://github.com/os1ai/os1/blob/main/notebook/agentchat_surfer.ipynb).
- integration examples like using [guidance](https://github.com/os1ai/os1/blob/main/notebook/agentchat_guidance.ipynb) to generate structured response.
