...
- task ([Task](https://github.com/os1ai/os1/tree/main/autogen/agentchat/contrib/agent_eval/task.py)): The task to evaluate.
...
- llm_config (dict or bool): llm inference configuration.
- criteria ([Criterion](https://github.com/os1ai/os1/tree/main/autogen/agentchat/contrib/agent_eval/criterion.py)): A list of criteria for evaluating the utility of a given task. This can either be generated by the `generate_criteria` function or manually created.
- task ([Task](https://github.com/os1ai/os1/tree/main/autogen/agentchat/contrib/agent_eval/task.py)): The task to evaluate. It should match the one used during the `generate_criteria` step.
...
Please refer to our [paper](https://arxiv.org/abs/2405.02178) and [codebase](https://github.com/os1ai/os1/tree/main/autogen/agentchat/contrib/agent_eval) for more details about AgentEval.
