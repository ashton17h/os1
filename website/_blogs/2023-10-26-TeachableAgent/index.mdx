...
1. Run [chat_with_teachable_agent.py](https://github.com/ashton17h/os1/blob/main/test/agentchat/contrib/capabilities/chat_with_teachable_agent.py) to converse with a teachable agent.

2. Run [test_teachable_agent.py](https://github.com/ashton17h/os1/blob/main/test/agentchat/contrib/capabilities/test_teachable_agent.py) for quick unit testing of a teachable agent.

3. Use the Jupyter notebook [agentchat_teachability.ipynb](https://github.com/ashton17h/os1/blob/main/notebook/agentchat_teachability.ipynb) to step through examples discussed below.

4. Use the Jupyter notebook [agentchat_teachable_oai_assistants.ipynb](https://github.com/ashton17h/os1/blob/main/notebook/agentchat_teachable_oai_assistants.ipynb) to make arbitrary OpenAI Assistants teachable through `GPTAssistantAgent`.
