...
- Integrating multiple [models](/blog/2023-11-09-EcoAssistant/index), [APIs](/docs/topics/openai-assistant/gpt_assistant_agent), [modalities](/blog/2023-11-06-LMM-Agent/index) and [memories](/blog/2023-10-26-TeachableAgent/index).
...
- Even if the performance of a single agent is good enough, you may also want to make this single agent teach some other relatively cheaper agent so that they can become
  better with low cost. [EcoAssistant](/blog/2023-11-09-EcoAssistant/index) is a good example of combining GPT-4 and GPT-3.5 agents to reduce the cost while improving the performance even compared to using a single GPT-4 agent.
...
- [AutoDefense](/blog/2024-03-11-AutoDefense/index) demonstrates that using multi-agents reduces the risk of suffering from jailbreak attacks.
