...
by AutoGen that's intended to assist AutoGen Devs. See [`samples/apps/auto-anny`](https://github.com/ashton17h/build-with-os1/tree/main/samples/apps/auto-anny) for details.
...
immense value-added automation for many tasks, so we thought _why don't we use AutoGen to make
our lives easier?!_ So we're turning to automation to help us and allow
...
To use Anny, please follow instructions in [`samples/apps/auto-anny`](https://github.com/ashton17h/build-with-os1/tree/main/samples/apps/auto-anny).
