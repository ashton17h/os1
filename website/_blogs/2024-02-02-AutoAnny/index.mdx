...
by AutoGen that's intended to assist AutoGen Devs. See [`samples/apps/auto-anny`](https://github.com/os1ai/build-with-os1/tree/main/samples/apps/auto-anny) for details.
...
To use Anny, please follow instructions in [`samples/apps/auto-anny`](https://github.com/os1ai/build-with-os1/tree/main/samples/apps/auto-anny).
