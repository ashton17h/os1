...
? item.image
: `https://mintlify.s3.us-west-1.amazonaws.com/os1ai/static/img/gallery/${item.image}`
: `https://mintlify.s3.us-west-1.amazonaws.com/os1ai/static/img/gallery/default.png`
}
style={{
          height: 150,
          width: "fit-content",
...
const colab_href = `https://colab.research.google.com/github/os1ai/os1/blob/main/${item.source}`;
const github_href = `https://github.com/os1ai/os1/blob/main/${item.source}`;
