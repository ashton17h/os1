...
export const notebooksMetadata = [
  ...
  {
    title:
      "Using Neo4j's graph database with os1 agents for Question & Answering",
  ...
  },
  {
    ...
    link: "/notebooks/agentchat_realtime_swarm_websocket",
  ...
  },
  {
    ...
    description:
      "Use ReasoningAgent for o1 style reasoning in Agentic workflows with LLMs using os1",
    image: null,
  ...
  },
  {
    ...
    image: null,
    tags: ["web", "nested chat", "tool/function"],
    source: "/notebook/agentchat_surfer.ipynb",
  },
  {
    title: "Swarm Orchestration with os1",
  ...
  {
    title: "Enhanced Swarm Orchestration with os1",
  ...
  },
  {
    ...
    link: "/notebooks/tools_chat_context_dependency_injection",
  ...
  {
    title:
      "Using Neo4j's native GraphRAG SDK with os1 agents for Question & Answering",
    link: "/notebooks/agentchat_graph_rag_neo4j_native",
    description:
